...
static const yytype_uint16 yyrline[] =
{
     ...
     190,   190,   244,   267,   290,   293,   316,   339,   342,   343,
     346,   350,   357,   346,   369,   371,   369,   387,   434,   435,
     436,   437,   438,   439
};
#endif
...
#line 268 "synt.y" /* yacc.c:1646  */
    {
            if ( ((yyvsp[-2].Str).declared==0) && ((yyvsp[0].Str).declared==0) ){
                if ( strcmp((yyvsp[-2].Str).type,(yyvsp[0].Str).type)==0){
                    ...
                    (yyval.Str).Compatibilite=1;
                    (yyval.Str).type=(yyvsp[0].Str).type; 
                    printf("\nL%2d C%2d | ERREUR SEMANTIQUE: Incompatibilité de types entre opérands soustraction %s avec %s !",nbligne,nbcolonne,(yyvsp[-2].Str).type,(yyvsp[0].Str).type);
...
#line 1583 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 290 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=(yyvsp[0].Str).val; (yyval.Str).type=(yyvsp[0].Str).type;}
#line 1589 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 294 "synt.y" /* yacc.c:1646  */
    {
            if ( ((yyvsp[-2].Str).declared==0) && ((yyvsp[0].Str).declared==0) ){
                if ( strcmp((yyvsp[-2].Str).type,(yyvsp[0].Str).type)==0){
                    (yyval.Str).type=(yyvsp[-2].Str).type; 
                    ...
                    (yyval.Str).Compatibilite=1;
                    (yyval.Str).type=(yyvsp[0].Str).type; 
                    printf("\nL%2d C%2d | ERREUR SEMANTIQUE: Incompatibilité de types entre opérands multiplication %s avec %s !",nbligne,nbcolonne,(yyvsp[-2].Str).type,(yyvsp[0].Str).type);
...
#line 1643 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 37:
#line 339 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=(yyvsp[0].Str).val; (yyval.Str).type=(yyvsp[0].Str).type;}
#line 1649 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 38:
#line 342 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=(yyvsp[0].Str).val; (yyval.Str).type=(yyvsp[0].Str).type;}
#line 1655 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 343 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=(yyvsp[0].Str).val; (yyval.Str).type=(yyvsp[0].Str).type;}
#line 1661 "synt.tab.c" /* yacc.c:1646  */
    break;
...
#line 1670 "synt.tab.c" /* yacc.c:1646  */
  ...
  case 41:
#line 350 "synt.y" /* yacc.c:1646  */
    {        
                    empiler_if(Num_Qc);
                    Ajouter_Quad("BR","","","");
                    sauv_br_to_cond=Num_Qc;
          }
#line 1680 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 357 "synt.y" /* yacc.c:1646  */
    {
                sauv_BR=depiler_if();
...
#line 1694 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 369 "synt.y" /* yacc.c:1646  */
    {   wich_cond=1; empiler_while(Num_Qc); }
#line 1700 "synt.tab.c" /* yacc.c:1646  */
    break;
...
#line 1708 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 375 "synt.y" /* yacc.c:1646  */
    {
...
#line 1723 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 47:
#line 388 "synt.y" /* yacc.c:1646  */
    {
...
#line 1772 "synt.tab.c" /* yacc.c:1646  */
  ...
  case 48:
#line 434 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=strdup("==");}
#line 1778 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 49:
#line 435 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=strdup("!=");}
#line 1784 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 50:
#line 436 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=strdup("<");}
#line 1790 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 51:
#line 437 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=strdup("<=");}
#line 1796 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 52:
#line 438 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=strdup(">");}
#line 1802 "synt.tab.c" /* yacc.c:1646  */
    break;

  case 53:
#line 439 "synt.y" /* yacc.c:1646  */
    {(yyval.Str).val=strdup(">=");}
#line 1808 "synt.tab.c" /* yacc.c:1646  */
    break;


#line 1812 "synt.tab.c" /* yacc.c:1646  */
      default: break;
    }
